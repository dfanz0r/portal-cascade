...
declare namespace mod {
    ...
    /** Returns the AreaTrigger associated with the current event */
    export function EventAreaTrigger(): AreaTrigger;

    /** Returns the CapturePoint associated with the current event */
    export function EventCapturePoint(): CapturePoint;

    /** Returns the DamageType associated with the current event */
    export function EventDamageType(): DamageType;

    /** Returns the DeathType associated with the current event */
    export function EventDeathType(): DeathType;

    /** Returns the EmplacementSpawner associated with the current event */
    export function EventEmplacementSpawner(): EmplacementSpawner;

    /** Returns the HQ associated with the current event */
    export function EventHQ(): HQ;

    /** Returns the InteractPoint associated with the current event */
    export function EventInteractPoint(): InteractPoint;

    /** Returns the MCOM associated with the current event */
    export function EventMCOM(): MCOM;

    /** Returns the normal vector associated with the current event */
    export function EventNormal(): Vector;

    /** Returns the number value associated with the current event */
    export function EventNumber(): number;

    /** Returns the other player involved in the current event */
    export function EventOtherPlayer(): Player;

    /** Returns the player associated with the current event */
    export function EventPlayer(): Player;

    /** Returns the point (position vector) associated with the current event */
    export function EventPoint(): Vector;

    /** Returns the vehicle seat number associated with the current event */
    export function EventSeat(): number;

    /** Returns the Sector associated with the current event */
    export function EventSector(): Sector;

    /** Returns the Spawner associated with the current event */
    export function EventSpawner(): Spawner;

    /** Returns the SpawnPoint associated with the current event */
    export function EventSpawnPoint(): SpawnPoint;

    /** Returns the Team associated with the current event */
    export function EventTeam(): Team;

    /** Returns the UI button event type associated with the current event */
    export function EventUIButtonEvent(): PortalEnum;

    /** Returns the UIWidget associated with the current event */
    export function EventUIWidget(): UIWidget;

    /** Returns the Vehicle associated with the current event */
    export function EventVehicle(): Vehicle;

    /** Returns the VehicleSpawner associated with the current event */
    export function EventVehicleSpawner(): VehicleSpawner;

    /** Returns the WaypointPath associated with the current event */
    export function EventWaypointPath(): WaypointPath;

    /** Returns the WeaponUnlock associated with the current event */
    export function EventWeapon(): WeaponUnlock;

    /** Returns the WorldIcon associated with the current event */
    export function EventWorldIcon(): WorldIcon;

    // Array Utility Functions

    /** Returns the current element being iterated over in an array operation */
    export function CurrentArrayElement(): Any;

    /** Returns a new array containing only elements that match the predicate function */
    export function FilteredArray(array: Array, predicate: Any): Array;

    /** Returns the index of the first element in the array where the predicate returns true, or -1 if not found */
    export function IndexOfFirstTrue(array: Array, predicate: Any): number;

    /** Returns true if the predicate function returns true for all elements in the array */
    export function IsTrueForAll(array: Array, predicate: Any): boolean;

    /** Returns true if the predicate function returns true for any element in the array */
    export function IsTrueForAny(array: Array, predicate: Any): boolean;
